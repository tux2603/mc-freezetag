...
execute at @a[team=evilturtles,scores={health=0..18}] if entity @a[team=michaelreeves,distance=..5] run scoreboard players set @a[team=evilturtles,scores={health=0..18}] callstack00 1

# Freeze the player that was tagged and Make them blind and stuck for a bit
effect clear @a[scores={callstack00=1}]
...
execute if entity @a[scores={callstack00=1}] run effect clear @a[team=michaelreeves]
execute if entity @a[scores={callstack00=1}] run clear @a[team=michaelreeves]
execute if entity @a[scores={callstack00=1}] run effect give @a[team=michaelreeves] minecraft:glowing 1000000 1 true
execute if entity @a[scores={callstack00=1}] run replaceitem entity @a[team=michaelreeves] armor.head minecraft:turtle_helmet{Enchantments:[{id:unbreaking,lvl:1000},{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}]}
execute if entity @a[scores={callstack00=1}] run replaceitem entity @a[team=michaelreeves] armor.chest minecraft:leather_chestplate{Enchantments:[{id:unbreaking,lvl:1000},{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}],display:{color:4635721}}
execute if entity @a[scores={callstack00=1}] run replaceitem entity @a[team=michaelreeves] armor.legs minecraft:leather_leggings{Enchantments:[{id:unbreaking,lvl:1000},{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}],display:{color:4635721}}
execute if entity @a[scores={callstack00=1}] run team join evilturtles @a[team=michaelreeves]
execute if entity @a[scores={callstack00=1}] at @a run execute at @a run playsound minecraft:entity.lightning_bolt.thunder hostile @a ~ ~ ~ 1000
