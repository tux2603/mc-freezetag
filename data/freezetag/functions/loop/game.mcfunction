...
execute at @a[team=evilturtles,scores={health=0..18}] if entity @a[team=michaelreeves,r=..4] run scoreboard players set @a[team=evilturtles,scores={health=0..18}] freeze 1
